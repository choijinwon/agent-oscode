...
입력창 아래 **첨부 · BUILD/PLAN · 모델 · 전송/중단** 버튼을 마우스로 클릭할 수 있습니다. **F9**는 프로젝트 파일 첨부, **F10**은 모델 설정입니다. 좁은 화면은 첨부·전송 버튼만 표시합니다. 마우스 추적을 켜므로 텍스트 드래그 선택은 터미널에 따라 Shift/Option 키가 필요할 수 있으며, 답변 복사는 F6를 사용할 수 있습니다.
