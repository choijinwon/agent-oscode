...
for (const file of ['style.css', 'app.js', 'design-studio.png', 'design-mobile.png', 'design-admin.png', 'design-interactions.png']) await copyFile(path.join(source, file), path.join(output, file));
