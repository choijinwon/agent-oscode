...
import {erpCatalog,erpMarkup,erpStyles} from './design-erp.js';
export const designCatalog=[
 ...
 ...mobileCatalog, ...adminCatalog, ...patternCatalog, ...erpCatalog
];
...
.oc-design{box-sizing:border-box;color:var(--oc-text);font-family:var(--oc-font);font-size:15px;line-height:1.6;-webkit-font-smoothing:antialiased;padding:var(--oc-spacing);background:var(--oc-surface);border:1px solid var(--oc-border);border-radius:var(--oc-radius);max-width:100%;min-width:0;box-shadow:0 2px 4px color-mix(in srgb,var(--oc-text) 3%,transparent)}
.oc-design *{box-sizing:border-box}.oc-design [hidden]{display:none!important}.oc-design h2{margin:0 0 18px;font-size:1.4em;line-height:1.35;letter-spacing:-.035em;font-weight:700}.oc-design p{margin:10px 0}.oc-design form{display:grid;gap:12px}.oc-design label{font-weight:600;font-size:.9em}.oc-design button,.oc-design input{font:inherit}.oc-design input:not([type=checkbox]){width:100%;min-width:0;padding:10px 12px;border:1px solid var(--oc-border);background:var(--oc-surface);color:var(--oc-text);border-radius:calc(var(--oc-radius)*.65)}
.oc-design button{cursor:pointer;border:1px solid transparent;border-radius:calc(var(--oc-radius)*.65);padding:10px 16px;background:var(--oc-accent);color:var(--oc-accentText);font-weight:600;min-height:42px}.oc-design button:not(:disabled):hover{filter:brightness(.96)}.oc-design :focus-visible{outline:3px solid var(--oc-accent);outline-offset:3px}.oc-design button:disabled{opacity:.45;cursor:not-allowed}.oc-design[data-size=small] button{padding:6px 12px;min-height:34px}.oc-design[data-size=large] button{padding:14px 22px;min-height:48px}.oc-design[data-variant=outline] button{background:transparent;color:var(--oc-accent);border-color:var(--oc-accent)}.oc-design[data-variant=soft] button{background:color-mix(in srgb,var(--oc-accent) 12%,var(--oc-surface));color:var(--oc-accent)}
...
.oc-design input::placeholder{color:var(--oc-muted);opacity:.8}.oc-design input:disabled{color:var(--oc-muted);background:var(--oc-background)}.oc-design thead th{font-size:.85em;letter-spacing:.01em;color:var(--oc-muted);font-weight:600;background:var(--oc-background)}.oc-design tbody th{font-weight:600}.oc-design caption{letter-spacing:-.02em}.oc-design .oc-table-scroll{border:1px solid var(--oc-border);border-radius:calc(var(--oc-radius)*.8)}.oc-design .oc-table-scroll caption{padding:16px}.oc-design tbody tr:last-child td,.oc-design tbody tr:last-child th{border-bottom:0}
`;
...
export function designCss(tokens=defaultTheme,scope="",mobile=false,admin=false,interaction=false,erp=false){return `.oc-design${scope?`[data-design="${scope}"]`:""}{${themeCss(tokens,true)}}\n${designStyles}${designMotionStyles}${mobile?mobileStyles:''}${admin?adminStyles:''}${interaction?patternStyles:''}${erp?erpStyles:''}`;}
